...
class AdminCompanyInformationController extends CBController
{
    ...
    public function cbInit()
    {
        ...
        # OLD START FORM
        //$this->form = [];
        //$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:company_information","placeholder"=>"Please enter a valid email address"];
