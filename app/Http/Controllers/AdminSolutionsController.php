...
class AdminSolutionsController extends CBController
{
    ...
    {
        //Your code here
        if ($_REQUEST['parent_id'] == null && ! $_REQUEST["q"]) {
            $query->where(function ($query) {
                $query->where('solutions.parent_id', null)
                    ->orWhere('solutions.parent_id', 0);
            });
        }
    }
