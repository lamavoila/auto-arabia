            ...
            self.validate({
                ...
                submitHandler: function (form) {
                    ...
                    if (!$("#g-recaptcha-response").val()) {
                        $(form).parent().find(".result").html("<span class='alert-danger p-4'>Recaptcha Error</span>");
                        return false;
                    }
                    $.post(
                        $(form).attr("action"),
                        $(form).serialize(),
                        function (response) {
                            $(form).parent().find(".result").html("<span class='alert-error p-4'>" + response.message + "</span>");
