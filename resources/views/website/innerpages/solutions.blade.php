...
@section('content')
    ...
    <section class="page-header">
        <div class="page-header-bg" style="background-image: url({{ asset("assets/bg-images/solutions.jpg") }})">
        </div>
                    ...
                    <div class="services-details__left">
                        <div class="service-details__category">
                            <ul class="service-details__category-list list-unstyled">
                                @foreach ($mainSolutions as $solution)
                                    <li class="{{ ($loop->iteration == 1 ? "active" : "") }}">
                                        <a href="{{ url("solutions/" . $solution->slug) }}">{{ $solution->title}}<span
                        ...
                        <div class="service-details__need-help">
                            ...
                            <div class="service-details__need-help-contact" style="direction: ltr;">
                                        ...
                                        <div class="services-two__single">
                                            <div class="services-two__img-box">
                                                <div class="services-two__img">
                                                    <img width="370" height="220" style="object-fit: cover;" src="{{ asset($childSolution->image) }}" alt="">
                                                </div>
